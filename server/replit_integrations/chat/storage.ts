...
export interface IChatStorage {
  ...
  createConversation(title: string, plotId?: string | null): Promise<typeof conversations.$inferSelect>;
...
export const chatStorage: IChatStorage = {
  ...
  async createConversation(title: string, plotId?: string | null) {
    const [conversation] = await db.insert(conversations).values({ title, plotId: plotId || null }).returning();
    return conversation;
  },
